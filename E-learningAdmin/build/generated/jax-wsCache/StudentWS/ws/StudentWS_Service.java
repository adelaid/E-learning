 ...
 * 
 */
@WebServiceClient(name = "StudentWS", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/StudentWS/StudentWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTWS_QNAME = new QName("http://ws/", "StudentWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/StudentWS/StudentWS?wsdl");
    ...
    public StudentWS getStudentWSPort() {
        return super.getPort(new QName("http://ws/", "StudentWSPort"), StudentWS.class);
    }
    ...
    public StudentWS getStudentWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "StudentWSPort"), StudentWS.class, features);
    }

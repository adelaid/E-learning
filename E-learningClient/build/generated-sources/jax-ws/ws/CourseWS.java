...
public interface CourseWS {
     ...
     * @param courseId
     * @return
     *     returns java.util.List<ws.Material>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getMaterialsByCourse", targetNamespace = "http://ws/", className = "ws.GetMaterialsByCourse")
    @ResponseWrapper(localName = "getMaterialsByCourseResponse", targetNamespace = "http://ws/", className = "ws.GetMaterialsByCourseResponse")
    @Action(input = "http://ws/CourseWS/getMaterialsByCourseRequest", output = "http://ws/CourseWS/getMaterialsByCourseResponse")
    public List<Material> getMaterialsByCourse(
    ...
    @WebMethod
    @Oneway
    @RequestWrapper(localName = "addMaterial", targetNamespace = "http://ws/", className = "ws.AddMaterial")
    @Action(input = "http://ws/CourseWS/addMaterial")

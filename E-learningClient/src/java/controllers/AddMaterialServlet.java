...
public class AddMaterialServlet extends HttpServlet {
   ...
   String name=request.getParameter("name");
        addMaterial(courseId, urlm, name);
    ...
    private void addMaterial(java.lang.Long courseId, java.lang.String url, java.lang.String name) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        ws.CourseWS port = service.getCourseWSPort();
        port.addMaterial(courseId, url, name);
    }

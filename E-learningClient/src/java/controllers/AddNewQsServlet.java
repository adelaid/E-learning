 ...
 * @author Ada
 */
@WebServlet(name = "AddNewQsServlet", urlPatterns = {"/AddNewQsServlet"})
public class AddNewQsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String answer= ans1+"##"+ans2+"##"+ans3;
        
        addQuestion(qs, answer, course);
         List<Question> qss= getAllQuestions();
                request.getSession().setAttribute("qs", qss);
    ...
    private void addQuestion(java.lang.String question, java.lang.String answer, java.lang.Long courseId) {
        // Note that the injected javax.xml.ws.Service reference as well as port objects are not thread safe.
        // If the calling of port operations may lead to race condition some synchronization is required.
        ws.ExamWS port = service.getExamWSPort();
        port.addQuestion(question, answer, courseId);
    }

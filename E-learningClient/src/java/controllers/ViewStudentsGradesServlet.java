 ...
 * @author Ada
 */
@WebServlet(name = "ViewStudentsGradesServlet", urlPatterns = {"/ViewStudentsGradesServlet"})
public class ViewStudentsGradesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     List<ExamGrades> eg= getExamGrade(examId);
    // request.getSession().setAttribute("students", students);
     
     request.getSession().setAttribute("eg", eg);
     request.getRequestDispatcher("ViewGrades2.jsp").forward(request, response);
    }

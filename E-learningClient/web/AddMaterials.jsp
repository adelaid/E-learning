<%-- 
    ...
    Created on : Aug 26, 2017, 2:45:06 PM
    Author     : Ada
--%>
...
<html>
    ...
    <body>
            ...
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav">
                   <li > <a href="IndexJSP.jsp">Home</a></li>
                    ...
                    <li class="active"><a href="AddMaterials.jsp">Add Materials</a></li>
                </ul>
            </div>
        </nav>  
        <div id="bigmenu">
        ...
        <div class="container">
            ...
            <form class="well form-horizontal"  method="post" action="AddMaterialServlet"  id="contact_form">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" for="password">URL</label>
                        <div class="col-md-4 inputGroupContainer">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <button type="submit" class="btn btn" >Add material </button>
                        </div>
                    </div>

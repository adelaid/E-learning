<%-- 
    Document   : ViewGrades
    Created on : Aug 25, 2017, 6:53:01 PM
    Author     : Ada
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <form class="well form-horizontal"  method="post" action="ViewStudentsGradesServlet"  id="contact_form">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label" >Choose Exam to view grades</label> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <button type="submit" class="btn btn" >View Grades! </button>
                        </div>
                    </div>
